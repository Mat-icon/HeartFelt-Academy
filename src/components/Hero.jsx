  ...
  return (
    <div className="irregular-curved-div" id="home">
      <div className="hold-contact">
        ...
        <a href="https://heartfeltholdings.com/hsl/" className="link1" target="_blank" rel="noopener noreferrer">Consulting Agency</a>
        <a href="#appotg" className="link2" onClick={() => scrollToSection('appotg')}>AppOTG</a>
        <a href="#worksdev" className="link3" onClick={() => scrollToSection('worksdev')}>WorkDevs</a>
      </div>
      <Navbar />
